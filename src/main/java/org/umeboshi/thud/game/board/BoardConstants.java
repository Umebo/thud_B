...
public final class BoardConstants {
    ...
    static final Map<String, Pair<Integer, Integer>> TILES_TO_COORDINATES = createTilesToCoordinatesMap();

    static final String[] CLASSIC_DWARF_STARTING_TILES = {
            "F15", "G15", "I15", "J15",
    ...
    static final String[] CLASSIC_TROLL_STARTING_TILES = {
            "G9", "H9", "I9", "G8", "I8", "G7", "H7", "I7"
    };
    static final String[] CLASSIC_OUTSIDE_TILES = {
        ...
        VERTICAL_AXIS.forEach(number -> {
            HORIZONTAL_AXIS.forEach(letter -> {
                map.put(
                        ...
                        Pair.of(BOARD_SIZE-number, letter.charAt(0)-65)
                );
            });
        });
        return map;
